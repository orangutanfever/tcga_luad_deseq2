...
This project follows the same pipeline as [tcga-brca-deseq2](https://github.com/orangutanfever/tcga-brca-deseq2), extending the analysis to lung adenocarcinoma and comparing pathway signatures across cancer types.
